...
% Title Section
    ...
    \affil{$^1$Centro de Investigaci\'on en Ciencias, Universidad Aut\'onoma del Estado de Morelos, Morelos, 62209, M\'exico}
    \affil{$^2$Unidad Acad\'emica de F\'isica, Universidad Aut\'onoma de Zacatecas, Zacatecas, 98060, M\'exico}
    \affil{$^3$Facultad de F\'isica, Universidad de La Habana, La Habana, 10400, Cuba}
